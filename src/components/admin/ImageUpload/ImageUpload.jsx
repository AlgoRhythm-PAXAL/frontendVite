    ...
    //         e.preventDefault();
    //         const result = await axios.post(`${backendURL}/admin/upload`,{image:image});
    //         try{
    ...
    //     return (
    //         <div className="">
    //             <div className="container mt-5 align-items-center justify-content-center">ImageUpload
    ...
    const ImageUpload = () => {
        ...
        const handleSubmit = async (e) => {
            ...
            try {
                ...
                toast.error('Upload failed',{description:err.response?.data?.message || 'Please try again later'});
            } finally {
