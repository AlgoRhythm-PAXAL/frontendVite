...
//         };
//         console.log("Setting userData:", newData);
//         return newData;
//       });
//       setIsLoading(false);
...
//       if (myData) {
//         console.log("Profile data received:", myData);
//         console.log("Avatar/profilePicLink value:", myData.profilePicLink);
//         console.log("Type of profilePicLink:", typeof myData.profilePicLink);
...
//         console.log("Avatar set to:", myData.profilePicLink);
//         console.log("userData after setting:", { 
//           name: admin?.name || myData.name || "Admin User",
//           avatar: myData.profilePicLink || null 
//         });
//       }
