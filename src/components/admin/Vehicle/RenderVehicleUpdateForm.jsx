    ...
    <>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            value={
              formData.registrationNo !== undefined
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="pickupDelivery">
        ...
        <div className="space-y-2">
          ...
          {isLoading ? (
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData({ ...formData, assignedBranch: value })
              }
            >
              <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Input
            type="number"
            value={
              formData.capableVolume !== undefined
                ? formData.capableVolume
                : rowData?.capableVolume || ""
            }
            onChange={(e) =>
              setFormData({
                ...formData,
                capableVolume: parseFloat(e.target.value) || "",
              })
            }
        ...
        <div className="space-y-2">
          ...
          <Input
            type="number"
            value={
              formData.capableWeight !== undefined
                ? formData.capableWeight
                : rowData?.capableWeight || ""
            }
            onChange={(e) =>
              setFormData({
                ...formData,
                capableWeight: parseFloat(e.target.value) || "",
              })
            }
