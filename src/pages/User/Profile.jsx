...
import { FiEdit, FiSave, FiX, FiUser, FiMail, FiPhone, FiMapPin, FiHome } from 'react-icons/fi';
    ...
    const fetchUser = async () => {
      try {
        ...
        if (response.data.data.user.profilePic) {
          setPreviewImage(`http://localhost:8000/api/auth/profile/${response.data.data.user.profilePic}`);
        }
      } catch (error) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-teal-50 rounded-lg p-6 border border-teal-100">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-sm font-medium text-teal-600">First Name</p>
                    <p className="mt-1 text-gray-800">{user.fName}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-teal-600">Last Name</p>
                  ...
                  <div>
                    <p className="text-sm font-medium text-teal-600">NIC</p>
                    <p className="mt-1 text-gray-800">{user.nic || 'Not provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-teal-600">Contact Number</p>
                    <p className="mt-1 text-gray-800">{user.contact || 'Not provided'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-teal-50 rounded-lg p-6 border border-teal-100">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-800">{user.address || 'Not provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-teal-600">Province</p>
                    <p className="mt-1 text-gray-800">{user.province || 'Not provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-teal-600">District</p>
                    <p className="mt-1 text-gray-800">{user.district || 'Not provided'}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-teal-600">City</p>
                    <p className="mt-1 text-gray-800">{user.city || 'Not provided'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-teal-50 rounded-lg p-6 border border-teal-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="fName" className="block text-sm font-medium text-teal-600 mb-1">
                        First Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="lName" className="block text-sm font-medium text-teal-600 mb-1">
                        Last Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="nic" className="block text-sm font-medium text-teal-600 mb-1">
                        NIC
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="contact" className="block text-sm font-medium text-teal-600 mb-1">
                        Contact Number
                      </label>
                      <input
                        type="tel"
                ...
                <div className="bg-teal-50 rounded-lg p-6 border border-teal-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="address" className="block text-sm font-medium text-teal-600 mb-1">
                        Address
                      </label>
                      <textarea
                        id="address"
                    ...
                    <div>
                      <label htmlFor="province" className="block text-sm font-medium text-teal-600 mb-1">
                        Province
                      </label>
                      <select
                        id="province"
                    ...
                    <div>
                      <label htmlFor="district" className="block text-sm font-medium text-teal-600 mb-1">
                        District
                      </label>
                      <select
                        id="district"
                    ...
                    <div>
                      <label htmlFor="city" className="block text-sm font-medium text-teal-600 mb-1">
                        City
                      </label>
                      <input
                        type="text"
