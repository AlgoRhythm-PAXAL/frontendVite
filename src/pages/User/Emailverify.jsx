...
//     setLoading(true);
//     try {
//       const response = await axios.post("http://localhost:8000/api/auth/verify", { otp: enteredOtp }, { withCredentials: true });
...
//     if (!email) return alert("Please enter your email to resend OTP");
...
//     setLoading(true);
//     try {
//        await axios.post("http://localhost:8000/api/auth/resend-otp", null, { withCredentials: true });
...
//         { withCredentials: true } // Ensure cookies (user session) are sent
//       );
//       alert(response.data.message);
//     } catch (error) {
//       alert(error.response?.data?.message || "Failed to resend OTP");
