...
// import animationData from "../assets/lottie/lottie_animation_1.json"; // Import your Lottie animation
...
//               Fort, secure, end reliable parcel delivery made easy.
//             </p>
//             <p className="text-lg text-gray-600 mb-6">
//               Took your packages in real-time and enjoy peace of mind with
//             </p>
//             <p className="text-lg text-gray-600 mb-6">
//               Wanna know? Contact us
//             </p>
//             <p className="text-lg text-gray-600 mb-6">
//               Trusted by Millions for Hassle-Free Deliveries Worldwide!
//             </p>
//             <button className="bg-teal-700 text-white px-6 py-2 rounded-lg hover:bg-teal-800 transition duration-300">
//               Contact Us
//             </button>
//           </div>
...
import Navbar from "../../components/User/Navbar";
import Lottie from "lottie-react";
import animationData from "../../assets/lottie/lottie_animation_1.json"; // Correct import path
...
const Parcel = () => {
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      {/* Seamless Parcel Delivery Section */}
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            {/* Text Content */}
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-6">Simplified!</p>
              <p className="text-lg text-gray-600 mb-6">
                Fort, secure, end reliable parcel delivery made easy.
              </p>
              <p className="text-lg text-gray-600 mb-6">
              ...
              <p className="text-lg text-gray-600 mb-6">Wanna know? Contact us</p>
              <p className="text-lg text-gray-600 mb-6">
                Trusted by Millions for Hassle-Free Deliveries Worldwide!
              </p>
              <button className="bg-teal-700 text-white px-6 py-2 rounded-lg hover:bg-teal-800 transition duration-300">
