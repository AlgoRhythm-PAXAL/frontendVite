...
//   {parcel.receiverId.receiverFullName || parcel.receiverId.receiverFullname}
// </div>
// <div className="text-sm text-gray-500">
//   {parcel.receiverId.receiverDistrict || parcel.receiverId.receiverdistrict}
// </div>
...
//         <FiTruck className="mr-1" /> {parcel.shippingMethod}
//       </span>
//       <span className="flex items-center text-sm text-gray-500">
...
//       <FiMapPin className="inline mr-1" /> {parcel.itemSize}
//     </div>
//   </td>
//   <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
//     <button className="text-green-600 hover:text-blue-900 mr-3">
//       Track
//     </button>
//     <button 
//      onClick={(e) => handleDetailsClick(e, parcel.parcelId)}

//       className="text-[#1f818e] hover:text-[#16646f]"
//     >
//       Details
//     </button>
//   </td>
