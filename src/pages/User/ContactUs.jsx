...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await fetch('http://localhost:8000/api/inquiries/postinquiry', {
      method: 'POST',
      headers: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="p-8">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="space-y-6">
                    ...
                    {/* Parcel Tracking No */}
                    <div>
                      <label htmlFor="parcelTrackingNo" className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <div>
                      <button
                        ...
                        className={`w-full flex items-center justify-center px-6 py-4 border border-transparent rounded-lg shadow-sm text-white font-medium ${
                          isSubmitting ? 'bg-[#1f818c]/80' : 'bg-[#1f818c] hover:bg-teal-600'
                        } transition-all`}
                      >
                        {isSubmitting ? (
                          'Sending...'
            ...
            <div className="flex  flex-col items-center lg:items-end mt-10 mb-5">
              ...
              <div className="w-full max-w-md">
                <Lottie animationData={contactus} loop={true} className="w-full h-auto" />
              </div>
