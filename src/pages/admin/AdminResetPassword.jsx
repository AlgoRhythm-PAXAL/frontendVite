...
const AdminResetPassword = () => {
    ...
    const [formData, setFormData] = useState({ email: email, password: '', confirmPassword: '' ,otp:otp});
        ...
        <div className="flex flex-col h-screen bg-Background items-center justify-center relative">
            <div className="flex flex-col items-center justify-center w-1/3 bg-white pb-8 px-16 rounded-3xl relative z-10">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center gap-5 w-full">
                    <FormField type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Enter new password" required />
                    <FormField type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} placeholder="Confirm new password" required />
